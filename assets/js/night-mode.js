...
class NightMode {
    ...
    createToggleButton() {
        ...
        toggleButton.className = 'flex items-center justify-center bg-white hover:bg-gray-100 text-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white p-2 rounded-lg font-medium transition duration-300';
