...
<head>
    ...
    <title>Barangay Hall Services - Admin Dashboard</title>
...
<body class="font-poppins bg-gray-50">
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900 font-garamond">Barangay Hall Services</h1>
                <p class="text-gray-600">Manage barangay services, documents, and requirements</p>
            </div>
