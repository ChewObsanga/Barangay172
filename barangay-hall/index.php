...
try {
    $total_residents = $conn->query("SELECT COUNT(*) FROM users WHERE role = 'resident'")->fetchColumn();
    $verified_residents = $conn->query("SELECT COUNT(*) FROM users WHERE role = 'resident' AND account_verified = 1")->fetchColumn();
    $pending_verification = $conn->query("SELECT COUNT(*) FROM users WHERE role = 'resident' AND (account_verified = 0 OR account_verified IS NULL)")->fetchColumn();
} catch (Exception $e) {
    $total_residents = 0;
